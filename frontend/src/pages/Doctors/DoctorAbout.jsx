  ...
  return   <div>
    <div>
        ...
        <span className='text-irisBlueColor font-bold text-[24px] leading-9'>
            Muhibur Rahman</span></h3>
            <p className='text__para'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, dolorem aut. Sit,
                 facere in? Iste dolorum illo quam eaque tempore!
                 Iste dolorum illo quam eaque tempore!
                 facere in? Iste dolorum illo quam eaque tempore!
                 Iste dolorum illo quam eaque tempore!
            </p>
        </div>
            ...
            <ul className='pt-4 md:p-5'>
                ...
                sm:items-end md:gap-5 mb-[30px]'>
                 <div>
                    ...
                    text-textColor'>PHD in Surgeon</p>
                   </div>
                   <p className='text-[14px] leading-5 font-medium
                    text-textColor'>New Apollo Hospital, New York</p>
                </li>
