...
const Signup = () => {
  ...
  const handleFileInputChange = async(event)=>{
    ...
    //later we will use cloudardinary to upload images
    ...
    <div className="max-w-[1170px] m-auto ">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="rounded-l-lg lg:pl-16 py-10">
          ...
          font-bold mb-10'>Create an <span className='text-primaryColor'>account</span></h3>
        ...
        <div className="mt-7">
          ...
          text-[18px] leading-[30px] px-4 py-3 rounded-lg">Sign Up</button>
        </div>
