...
const ServiceCard = ({item,index}) => {
    // name, desc, bgColor, textColor these are objects of item
    ...
    return   <div className='py-[30px] px-3 lg:px-5'>
        ...
        <Link to='/doctors' className='w-[44px] h-[44px] rounded-full
              border border-solid border-[#181A1E]  flex items-center justify-center group hover:bg-primaryColor
              hover:border-none'>
                <BsArrowRight className='group-hover:text-white w-6 h-5' />
              </Link>
              <span className='w-[44px] flex items-center justify-center text-[18px] leading-[30px]
