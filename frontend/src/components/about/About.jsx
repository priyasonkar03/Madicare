    ...
    <div className="container">
        ...
        lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-[670px] order-1 lg:order-2">
                ...
                as one of the best publics hospitals in the Nation and #1 in Texas. Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                </p>

                <p className="text__para mt-[30px]">Our best is something we strive for each day. caring for Our
                patients Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem autem corrupti ipsam.</p>
