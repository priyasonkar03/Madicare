    ...
    <div className="container">
      ...
      gap-[300]">
        ...
        <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
          ...
          <span><a href="https://github.com/priyasonkar03/priyasonkar03.git"><u> Priya Sonkar</u></a></span> all right reserved</p>
          <div className='flex items-center gap-3 mt-4'>
            {socialLinks.map((link,index)=>
            <Link to={link.path} key={index} className='w-9 h-9 border border-solid
            border-[#181A1E] rounded-full flex items-center justify-center group
