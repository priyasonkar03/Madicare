...
// const DoctorAccount = () => {
//   const [tab, setTab] = useState("overview"); // Move useState inside the component

//   // Define other variables and hooks as needed
...
//                 review manullay and approve within 3days.
//             </div>
//           </div>
//             )}
...
//                   <img src={data?.photo} alt="img" className='w-full'/>
//                   {/* <img src={photo} alt="" /> */}
//                   </figure>
                
//                 <div>
//                     <span className='bg-[#CCF0F3] text-irisBlueColor
//                     py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4
...
//                       </span>
//                     </div>
//                        <p className='text__para font-[15ox] lg:max-w-[390px] leading-6'>
//                           {data?.bio}</p>
//                     </div>
//                 </div>
//                 <DoctorAbout
